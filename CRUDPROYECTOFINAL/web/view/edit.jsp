        ...
        <div>
            <div>
                ...
                <form>
                    ...
                    <input class="form-control" type="text" name="txtNombre" value="<%= nuevoEmpleado.getNombres() %>"><br>
                    ...
                    <strong>User:</strong>
                    <input class="form-control" type="text" name="txtUser" value="<%= nuevoEmpleado.getUser() %>"><br>
