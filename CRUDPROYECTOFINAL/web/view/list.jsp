...
<html>
    ...
    <body>
        <div class="container">
            <h1 class="btn btn-success" class="text-center"> Datos en la entidad Empleado</h1>
            ...
            <table>
                ...
                <tbody>
                    <tr>
                        ...
                        <td class="text-center active"><%= emp.getNombres()%></td>
                        ...
                        <td class="text-center">
                            <a class="btn btn-warning" href="Controlador?accion=editar&IdEmpleado=<%=emp.getIdEmpleado()%>">Editar</a> 
                            <a class="btn btn-danger" href="Controlador?accion=eliminar&IdEmpleado=<%=emp.getIdEmpleado()%>">Delete</a>
